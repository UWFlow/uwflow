...
-- version: 1714376700000_replace_prof_teaches_course_mv_with_table
-- description: Revert changes: Drop public.prof_taught_course table, recreate materialized.prof_teaches_course MVIEW and dependencies.

-- Start Transaction
BEGIN;

---------------------------------- DROP NEW TABLE prof_taught_course ----------------------------------
...
DROP TABLE IF EXISTS public.parsed_prof_taught_course;
